...
public class BigDecimalMath
{
    ...
    // Commented out by Leif Rasmussen to avoid needing the import Vector.java from other sources.
//    public static OtherVector<BigInteger> cfrac(final BigDecimal x)
//    {
